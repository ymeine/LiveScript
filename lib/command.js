...
var LiveScript, path, fs, util, prelude, each, breakList, ref$, parseOptions, generateHelp, nameFromPath, version, this$ = this, slice$ = [].slice;
LiveScript = require('..');
path = require('path');
fs = require('fs');
util = require('util');
...
(function(it){
  ...
  var args, require_, ref$, say, sayWithTimestamp, warn, die, o, positional, e, validMapValues, that, filename, jsonCallback;
  args = arg$.args, require_ = arg$.require;
  ref$ = arg1$ != null
    ? arg1$
  ...
  default:
    ...
    if (o.map != null) {
      ...
      o.map = o.run || o.eval ? 'embedded' : 'none';
    }
    if (args === process.argv && !o.stdin && o.run) {
  ...
  function compileScript(filename, input, base){
    ...
    try {
      ...
      if (run) {
        ...
        print = json || o.print;
        t.output = LiveScript.compile(t.input, (ref$ = {}, import$(ref$, options), ref$.bare = false, ref$.run = run, ref$.print = print, ref$));
